    ...
    <div className="relative w-full">
      {showChatToggle && (
        <div className="flex items-center mb-4 space-x-4">
          ...
          <div className="ml-auto font-body-12 text-muted-foreground hidden md:block">
            Chat{" "}
            <kbd className="px-2 py-1.5 font-body-12 font-body-12-medium text-gray-800 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">
              Shift
            </kbd>{" "}
            +{" "}
